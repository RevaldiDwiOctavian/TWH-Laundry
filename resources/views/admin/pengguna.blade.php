                    ...
                    <tr>
                        ...
                        <td>
                          <div class="d-flex justify-content-center">
                            <button class="btn btn-warning" type="button" id="openedit" data-toggle="modal" data-target="#modaledit" value="">Edit</button>&nbsp | &nbsp
                            ...
                            <button id="opendelete" type="button" class="btn btn-danger" data-toggle="modal" data-target="#ConfirmDialog" value="">Hapus</button>
